        ...
        try:
            ...
            while 1:
                try:
                    ...
                    post = api.wall.get(owner_id= -40400418, domain= 'https://vk.com/public40400418', offset= 1, count= 1, v= 5.103)['items'][0]
                    if (
                            post['date'] > get_last_post_unix()                 and
                            (post['text'] == '') or ('UPD' in post['text'])     and
